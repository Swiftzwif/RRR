      ...
      <div className="max-w-6xl mx-auto">
        ...
        >
          ...
          <p className="text-xl text-sky-600 max-w-3xl mx-auto">
            Enter our giveaway to win life-changing prizes that accelerate your transformation.
            <br />
        ...
        >
          Winners selected randomly via cryptographic algorithm. Drawing happens 24 hours after giveaway ends.
        </motion.p>
      </div>
    </section>
  );
