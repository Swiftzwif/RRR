...
export default function Home() {
  ...
  const words = ["attention", "energy", "worth"];
  ...
  const features = [
    {
      ...
      description:
        "Discover if you're a Good Little Soldier, Conformist, or Commander through our comprehensive assessment",
      icon: Users,
    },
    {
    ...
    <>
      ...
      {showContent && (
        ...
        >
              ...
              <div className="lg:grid lg:grid-cols-2 lg:gap-12 items-center">
                ...
                >
                  ...
                  <div className="space-y-6 text-lg text-secondary leading-relaxed mb-8">
                    <p>Your story is about to change.</p>
                    <p>
                      If you don&apos;t like your current emotions — don&apos;t
                      worry, you&apos;re in the right place.
                    </p>
                    <p className="text-primary font-semibold">
                      Trajectory exists to help men ages 18–35 become fearless,
                      humble, compassionate leaders — to rise out of suffering
                      and into joy.
                    </p>
                  </div>
                ...
                >
                  <Card className="bg-gradient-to-br from-slate-900 via-slate-800 to-slate-900 border-2 border-[var(--brand-gold)] relative overflow-hidden shadow-2xl">
                    ...
                    <CardHeader className="text-center pb-6 relative z-10">
                      <Badge
                        variant="outline"
                        className="border-gold text-gold mb-4 mx-auto"
                      >
                        WHAT IS TRAJECTORY?
                      </Badge>
                      ...
                      <CardDescription className="text-orange-200 text-lg max-w-2xl mx-auto leading-relaxed">
                        A comprehensive system combining proven frameworks,
                        expert guidance, and a brotherhood of men committed to
                        transformation
                      </CardDescription>
                    </CardHeader>
                                ...
                                <div className="space-y-4 text-orange-100 text-lg leading-relaxed">
                                  <p>
                                    <strong className="text-white">
                                      At 25, everything changed.
                                    </strong>{" "}
                                    My mentor looked me in the eye and said:{" "}
                                    <span className="text-orange-300 font-semibold">
                                      &quot;Kill the boy.&quot;
                                    </span>
                                  </p>
                                  <p>
                                    It wasn&apos;t about violence—it was about
                                    transformation. Killing the version of
                                    yourself that seeks approval, avoids
                                    responsibility, and drifts through life.
                                  </p>
                                  <p className="text-white font-semibold">
                                    Trajectory was born from that moment—a
                                    complete system to help men command their
                            ...
                            <div className="relative overflow-hidden rounded-2xl bg-gradient-to-br from-orange-500/20 via-red-500/20 to-orange-600/20 border-2 border-orange-500/50 backdrop-blur-sm p-8">
                              ...
                              <div className="relative space-y-6">
                                ...
                                <div className="space-y-4 text-orange-100 text-lg leading-relaxed">
                                  <p>
                                    <strong className="text-white">
                                      Most men are blind to their actual
                                      trajectory.
                                    </strong>{" "}
                                    They think they&apos;re doing fine until
                                    reality hits.
                                  </p>
                                  <p>
                                    Our Life Assessment reveals your{" "}
                                    <span className="text-orange-300 font-semibold">
                                      Life Identity
                                    </span>
                                    —whether you&apos;re a Good Little Soldier,
                                    Conformist, or Commander. It measures 7
                                    critical domains of life and shows you
                                    exactly where you&apos;re winning and where
                                    you&apos;re losing.
                                  </p>
                                  <p className="text-white font-semibold">
                                    In 10 minutes, you&apos;ll have more clarity
                                    than most men get in 10 years.
                                  </p>
                                </div>
                              ...
                              <div className="relative space-y-6">
                                ...
                                <div className="space-y-4 text-orange-100 text-lg leading-relaxed">
                                  ...
                                  <p>
                                    Access{" "}
                                    <span className="text-orange-300 font-semibold">
                                      50+ curated book summaries
                                    </span>
                                    , frameworks from the greatest minds, and
                                    actionable strategies—all for free. The
                                    knowledge is out there. We&apos;ve just
                                    organized it for you.
                                  </p>
                                  <p className="text-white font-semibold">
                                    Trajectory exists for accountability and
                                    simplicity. The resources are yours. The
                                    transformation is up to you.
                                  </p>
                                </div>
          ...
          {/* Kill The Boy Course CTA */}
          <section className="py-20 bg-base relative overflow-hidden">
            <div className="absolute inset-0 opacity-10">
              <div className="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 w-96 h-96 bg-[#FFD700] rounded-full blur-3xl" />
            </div>
            ...
            <div className="max-w-5xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
              <motion.div
                ...
                viewport={{ once: true }}
              >
                <Card className="bg-gradient-to-br from-slate-900 via-slate-800 to-slate-900 border-2 border-[#FFD700] shadow-2xl relative overflow-hidden">
                  {/* Gold glow effect */}
                  ...
                  <CardContent className="p-12 relative z-10">
                    <div className="text-center mb-8">
                      ...
                      <div className="flex items-center justify-center gap-6 mb-8">
                        <div className="text-slate-400 line-through text-3xl">
                          $149
                        </div>
                        <div className="text-6xl md:text-7xl font-bold bg-gradient-to-r from-[#FFD700] to-[#FFA500] bg-clip-text text-transparent">
                          $97
                        </div>
                      ...
                      <p className="text-slate-400 mb-8">
                        Limited time until November 7th
                      </p>
                    </div>
                    ...
                    {/* Impact Statement */}
                    <div className="bg-slate-800/50 border border-[#FFD700]/30 rounded-xl p-6 mb-8">
                      <p className="text-slate-200 leading-relaxed italic text-center">
                        Organize your mind, evolve your consciousness, and
                        discover your infinite worth. This isn&apos;t
                        information—it&apos;s the operating system upgrade that
                        transforms how you command your attention, energy, and
                        money.
                      </p>
                    </div>
                    ...
                    <div className="text-center">
                      <Button
                        asChild
                        size="lg"
                        className="bg-gradient-to-r from-[#FFD700] to-[#FFA500] hover:from-[#FFA500] hover:to-[#FFD700] text-black text-lg font-bold px-12 py-6 h-auto shadow-xl hover:shadow-2xl transition-all duration-300 group"
                      >
                        <Link href="/products">
                      ...
                      <p className="text-slate-400 text-sm mt-4">
                        30-day money-back guarantee • Join thousands of men who
                        have transformed their trajectory — from good little
                        soldiers to conscious capital allocators
                      </p>
                    </div>
                  </CardContent>
                </Card>
            ...
            <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
              ...
              >
                ...
                <p className="text-xl text-secondary max-w-3xl mx-auto">
                  Take the Trajectory Assessment to understand where you are and
                  get a clear roadmap to where you want to be.
                </p>
              </motion.div>
            ...
            <div className="max-w-5xl mx-auto px-4 sm:px-6 lg:px-8">
              ...
              >
                ...
                <p className="text-xl text-secondary max-w-3xl mx-auto leading-relaxed">
                  Everything we offer can be done on your own. We&apos;re not
                  hiding anything. The books are available. The frameworks are
                  out there. The wisdom is accessible.
                </p>
              </motion.div>
                        ...
                        <div className="flex items-start gap-3">
                          ...
                          <div>
                            ...
                            <p className="text-secondary leading-relaxed">
                              ...
                              . We&apos;ve curated, organized, and distilled the
                              essential wisdom so you don&apos;t have to spend
                              years searching.
                            </p>
                          </div>
                        </div>
                      ...
                      <div className="space-y-4">
                        <div className="flex items-start gap-3">
                          ...
                          <div>
                            ...
                            <p className="text-secondary leading-relaxed">
                              Clear structure. Focused action. A community of
                              men committed to growth. Someone to meet with who
                              will hold you accountable to your word and your
                              transformation.
                            </p>
                          </div>
                        </div>
          ...
          <section className="py-20 bg-base relative overflow-hidden">
            ...
            <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 text-center relative z-10">
              ...
              >
                <h2 className="text-4xl md:text-5xl font-bold text-primary mb-6">
                  Inner Mastery. Outer Freedom.
                </h2>
                <p className="text-xl text-secondary mb-8 max-w-2xl mx-auto">
                  Join thousands of men who have transformed their trajectory —
                  from good little soldiers to conscious capital allocators.
                </p>
