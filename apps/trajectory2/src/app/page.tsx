...
export default function Home() {
  ...
  // Auto-cycle through tabs every 4 seconds (pause on hover)
  useEffect(() => {
    if (isPaused) return;
      ...
      <section className="relative min-h-screen flex items-center overflow-hidden">
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-20 relative z-10">
          <div className="lg:grid lg:grid-cols-2 lg:gap-12 items-start">
            <motion.div
              className="mb-12 lg:mb-0 lg:pt-16"
            ...
            >
              <div className="mb-6">
                ...
                <h1 className="text-6xl md:text-8xl font-bold mb-4 leading-tight text-primary">
                  Trajectory
                </h1>
                <h2 className="text-3xl md:text-4xl font-light text-gold mb-6 h-16 flex items-center">
              ...
              <div className="space-y-4 text-lg text-secondary leading-relaxed mb-6">
                <p>Transform into the commander of your life.</p>
                <p>
                  Most men drift through life unaware of their worth—distracted
                  by feeds, trapped in yesterday&apos;s thoughts, repeating the
                  same inputs and getting the same results.
                </p>
              ...
              <Card className="bg-gradient-to-br from-slate-900 via-slate-800 to-slate-900 border-2 border-[var(--brand-gold)] relative overflow-hidden shadow-2xl">
                ...
                <CardHeader className="text-center pb-6 relative z-10">
                  ...
                  <CardDescription className="text-orange-200 text-lg max-w-2xl mx-auto leading-relaxed">
                    A comprehensive system combining proven frameworks, expert
                    guidance, and a brotherhood of men committed to
                    transformation
                  </CardDescription>
                </CardHeader>
                          ...
                          <div className="relative space-y-6">
                            ...
                            <div className="space-y-4 text-orange-100 text-lg leading-relaxed">
                              ...
                              <p>
                                ...
                                transformation. Killing the version of yourself
                                that seeks approval, avoids responsibility, and
                                drifts through life.
                              </p>
                              <p className="text-white font-semibold">
                                Trajectory was born from that moment—a complete
                                system to help men command their attention,
                        ...
                        <div className="relative overflow-hidden rounded-2xl bg-gradient-to-br from-orange-500/20 via-red-500/20 to-orange-600/20 border-2 border-orange-500/50 backdrop-blur-sm p-8">
                          ...
                          <div className="relative space-y-6">
                            ...
                            <div className="space-y-4 text-orange-100 text-lg leading-relaxed">
                              <p>
                                <strong className="text-white">
                                  Most men are blind to their actual trajectory.
                                </strong>{" "}
                                They think they&apos;re doing fine until reality
                                hits.
                              </p>
                              <p>
                                ...
                                —whether you&apos;re a Drifter, Balancer, or
                                Architect. It measures 7 critical domains of
                                life and shows you exactly where you&apos;re
        ...
        <div className="max-w-5xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          >
            ...
            <p className="text-xl text-secondary max-w-3xl mx-auto leading-relaxed">
              Everything we offer can be done on your own. We&apos;re not hiding
              anything. The books are available. The frameworks are out there.
                    ...
                    <div className="flex items-start gap-3">
                      ...
                      <div>
                        ...
                        <p className="text-secondary leading-relaxed">
                          ...
                          and{" "}
                          <strong className="text-primary">simplicity</strong>.
                          We&apos;ve curated, organized, and distilled the
                          essential wisdom so you don&apos;t have to spend years
                          searching.
                        </p>
                      </div>
                    </div>
                  ...
                  <div className="space-y-4">
                    <div className="flex items-start gap-3">
                      ...
                      <div>
                        ...
                        <p className="text-secondary leading-relaxed">
                          Clear structure. Focused action. A community of men
                          committed to growth. Someone to meet with who will
                          hold you accountable to your word and your
                          transformation.
                        </p>
                      </div>
                    </div>
