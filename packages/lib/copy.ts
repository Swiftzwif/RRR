...
export const COPY = {
  ...
  brand: {
    ...
    description:
      "Discover what's shaping your path and how to raise your floor in 10 minutes.",
  },
  ...
  laneDiagnostic: {
    ...
    lanes: {
      sidewalk: {
        name: "Sidewalk Lane",
        description:
          "You're living in the moment, but the moment is costing you your future",
        characteristics: [
      ...
      slowlane: {
        name: "Slowlane",
        description:
          "You're building wealth, but you're trading time for money at a 1:1 ratio",
        characteristics: [
      ...
      fastlane: {
        name: "Fastlane",
        description:
          "You understand systems, but you might be missing the community and support",
        characteristics: [
  ...
  results: {
    ...
    cta: {
      course: {
        ...
        description:
          "Get access to our complete transformation course with 5 core modules.",
        price: "$99.99",
        button: "Buy Course",
      },
      coaching: {
        ...
        description:
          "Book a 1-on-1 coaching interview to create your personalized roadmap.",
        price: "$24.99",
  ...
  tbd: {
    course: {
      ...
      description:
        "Unlock your full potential with our comprehensive course designed to raise your floor across all life domains.",
      modules: [
        {
          title: "Awareness",
          description:
            "Develop deep self-awareness and understand your current trajectory patterns.",
          status: "coming_soon",
        },
        {
          title: "Inner State",
          description:
            "Master your emotional regulation and inner world management.",
          status: "coming_soon",
        },
        {
          title: "Rewrite Story",
          description:
            "Transform limiting beliefs and create empowering narratives.",
          status: "coming_soon",
        },
        {
          title: "Raise Standards",
          description:
            "Set and maintain higher standards across all life domains.",
          status: "coming_soon",
        },
        {
          title: "Relationship Inventory",
          description:
            "Audit and optimize your relationships for maximum growth.",
          status: "coming_soon",
        },
      ],
    },
    coaching: {
      ...
      description:
        "Work directly with our coaches to create a customized roadmap for your specific situation and goals.",
      process: [
    ...
    community: {
      ...
      description:
        "Join a private community of like-minded individuals on their own trajectory journeys. Share wins, get support, and accelerate your growth.",
      features: [
